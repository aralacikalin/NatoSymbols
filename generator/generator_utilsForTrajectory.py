...
def read_into_dic_extra(directory, re_in, output_dir=None, directory2=None, excess_str=100):
    """
    Reads all images in a directory and returns them as a dictionary of numpy arrays where keys are the labels.
