...
def main(
    ...
    for i in range(len(data_labels)):
        labels = get_labels(np.array(data_labels[i]))
...
def parse_opt():
    ...
    parser.add_argument('--symbols_dir', type=str, default='symbols', help='Directory in which the sample of tactical tasks are')
    parser.add_argument('--unit_symbols_dir', type=str, default='unit_symbols', help='Directory in which the sample of unit symbols are')
    parser.add_argument('--extras_dir', type=str, default='extras', help='Directory in which the sample of extras is')
